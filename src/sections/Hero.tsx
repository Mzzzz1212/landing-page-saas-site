                ...
                <div className="md:flex items-center">
                    <div className="md:w-[478px]">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text mt-6">Pathway
                            to productivity</h1>
                        <p className="text-xl text-[#010D3E] tracking-tight mt-6">Celebrate the joy of accomplishment
                            with
                            an app designed to track your progress, motivate your efforts and celebrate your
                            successes.</p>
                    ...
                    <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
                        <motion.img src={cogImage.src} alt="Cog Image"
                                    className="md:absolute md:h-full md:w-auto md:max-w-none md:-left-6 lg:left-0 transition"
                                    animate={{
                                        translateY: [-30, 30],
                                    }}
                                    transition={{
                        ...
                        />
                        <motion.img src={cylinderImage.src} alt="Cylinder Image" width={220} height={220}
                                    className="hidden md:block -top-8 -left-32 md:absolute transition"
                                    style={{
                                        translateY: translateY,
                                    }}
                        />
                        <motion.img src={noodleImage.src} alt="Noodle Image" width={220}
